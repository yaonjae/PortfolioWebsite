...
const Education = () => {
  const { ref, inView } = usePageInView("Education");
  ...
  return (
    <>
      <div ref={ref} id="Education" className="w-full h-fit my-28">
        <div className="mx-56 h-full flex flex-col justify-center items-center gap-10">
          <motion.h1
            initial={{ opacity: 0 }}
            animate={animateH1}
            className="text-center my-2 font-bold text-3xl lg:text-4xl xl:text-5xl mb-10"
          >
            <span>Education</span>
          </motion.h1>
            ...
            {educationData.map((education, index) => (
              ...
              >
                <div className="w-full flex justify-center items-center gap-2">
                  <div className="w-20 h-16 bg-transparent border-cyan-500 border-4 rounded-full flex justify-center items-center drop-shadow-lg">
                    <h1 className="font-bold text-blue-500 text-2xl drop-shadow-lg">
                      {education.count}
                    </h1>
                  </div>
                  <div className="border-cyan-500 border-b-8 rounded-full w-full"></div>
                </div>
